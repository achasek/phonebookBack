// index.js is the entry point and means of starting the application
// and all of its routers

const app = require('./app') // the actual Express application
const config = require('./utilities/config')
const logger = require('./utilities/logger')

// this just says to check env file for PORT, and if no such variable
...
// ------------------- CODE PRIOR TO NEW FILE STRUCTURE -------------------------
